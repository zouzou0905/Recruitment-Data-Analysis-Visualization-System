...
class User(models.Model):
    ...
    password = models.CharField('密码', max_length=2555, default='')
    educational = models.CharField('学历', max_length=255, default='')
    workExperience = models.CharField('工作经验', max_length=255, default='')
    address = models.CharField('意向城区', max_length=255, default='')
    work = models.CharField('意向岗位', max_length=255, default='')
    avatar = models.FileField("用户头像", upload_to="avatar", default="avatar/def.png")
    createTime = models.DateTimeField('创建时间', auto_now_add=True)
